    ...
    public partial class ReviewSentimentModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(@"Comment", @"Comment")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(l1Regularization:7.08763571306271F,l2Regularization:0.912014627781131F,labelColumnName:@"Sentiment",featureColumnName:@"Features"))      
